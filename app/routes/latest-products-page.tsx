// Theme override for the latest products route (`/{-$locale}/latest-products`), wired in via
// `app/routes.ts`. NOT `// @auto-generated` — the tanstack plugin leaves this
// file alone; the engine's own `latest-products.tsx` stays generated and unused.
//
...
export const Route = createFileRoute('/{-$locale}/latest-products')({
  ...
  loader: ({ deps, params }): Promise<ProductListLoaderData> =>
    ProductListing.loader({
      params: { source: 'latest', title: 'Latest Products', slug: 'latest-products' },
