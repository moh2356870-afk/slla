// Theme override for the most sales products route (`/{-$locale}/most-sales-products`), wired in via
// `app/routes.ts`. NOT `// @auto-generated` — the tanstack plugin leaves this
// file alone; the engine's own `most-sales-products.tsx` stays generated and unused.
//
...
export const Route = createFileRoute('/{-$locale}/most-sales-products')({
  ...
  loader: ({ deps, params }): Promise<ProductListLoaderData> =>
    ProductListing.loader({
      params: { source: 'sales', title: 'Most Sales Products', slug: 'most-sales-products' },
